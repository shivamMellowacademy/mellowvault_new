...
<section><br><br><br><br><center>
         <div class="row">  
            ...
            <div class="col-8 col-lg-8 col-sm-8 col-md-8" style=" background-color: #d9d0d02e;border-radius: 20px;padding: 20px 20px 20px 20px;left: 20%;">
                ...
                <h1 class="text-dark">YOUR ORDER IS COMPLETED!</h1>
                ...
                <p class="text-dark">Now you can download your product from Downloads option.</p>
                <hr style="width:97%">
                <a class="btn text-dark btn-primary btn-lg" href="{{route('index')}}" role="button">CONTINUE SHOPPING <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
