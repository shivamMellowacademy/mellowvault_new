...
@section('content')
    ...
    <section class="products">
        <header>
            <div class="container">
                <h4 class="title">Our Sub Products</h4>
            </div>
        </header>
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <?php
                         foreach($pro as $pp) {   
                            session(['id' => $pp->id ]);
                            $url = route('product_details',['id'=>''.$pp->id.'']);
                         ?>
                            ...
                            <article>
                                ...
                                if(empty(Session::get('user_login_id'))) { ?>
                                    ...
                                    <div class="btn btn-add">
                                        <a href="{{route('login')}}" class="add_to_cart" value="{{$pp->id}}" style="color:white;"><i class="icon icon-cart"></i></a>
                                    </div>

                                <?php } else{ ?>

                                    <div class="btn btn-add">
                                        <a href="javascript:void(0);" class="add_to_cart" value="{{$pp->id}}" style="color:white;"><i class="icon icon-cart"></i></a>
                                    </div>
                                ...
                                <div class="figure-grid">
                                    <?php if($pp->image == ''){ ?>
                                            ...
                                            <a href="<?php echo $url; ?>">
                                                <video controls controlsList="nodownload" data-play="hover" muted="muted" onmouseover="this.play()" onmouseout="this.pause();" ><source src="<?php echo URL::asset('public/upload/video/'.$pp->video.'') ?>" type="video/mp4" allowfullscreen></video>
                                            </a>
                                       
                                    <?php }else{ ?>
                                        <div class="image">
                                            <a href="<?php echo $url; ?>">
                                                <img src="<?php echo URL::asset('public/upload/product/'.$pp->image);?>" alt="image">
                                            </a>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="text">
                                        <h6 class="title">
                                            <a href="<?php echo $url; ?>"><?php echo $pp->name; ?></a>
                                        </h6>
                                        <!--<sub>$ 319,-</sub>-->
                                        <sup>INR <?php echo $pp->price; ?></sup>
                                    </div>
                                </div>
                            </article>
                        </div>  
        ...
        <div class="row">
                <div class="col-sm-12 col-xs-12 pagination-wrapper">
                    <div class="pagination justify-content-center">
                        <?php echo $pro->links("pagination::bootstrap-4"); ?> 
                    </div>      
                </div>
        </div>
    </section>      
