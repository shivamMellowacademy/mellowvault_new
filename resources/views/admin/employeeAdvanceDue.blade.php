                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <tr>
                                                    ...
                                                    <td>{{ $payment->email }}</td>
                                                    <td>₹{{ number_format($payment->perhr, 2) }}</td>
                                                    <td>₹{{ number_format($payment->payment_amount, 2) }}</td>
                                                    <td class="{{ ($payment->perhr - $payment->payment_amount) > 0 ? 'text-danger' : 'text-success' }}">
                                                        ₹{{ number_format(abs($payment->perhr - $payment->payment_amount), 2) }}
                                                    </td>
                                                    <td>
...
<script>
    $(document).ready(function() {
        ...
        $('.view-details').on('click', function() {
            ...
            $.get("{{ url('/admin/employee/details') }}/" + userId, function(data) {
