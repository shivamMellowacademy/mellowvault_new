...
<div class="page-content">
    <div class="page-info container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">All Service</a></li>
                               ...
                               <?php $i=1;
                                foreach($detail as $s) { ?>
                                    <tr>
                                        ...
                                        <td><img class="img-fluid img-thumbnail" src="<?php echo URL::asset('public/upload/service/'.$s->image.'') ?>" style="height:80px"></td>
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" onclick="alert('Are You Sure To Delete This?')" href="<?php echo route('delete_service',['id'=>''.$s->id.'']) ?>" ><i class="fa fa-trash"></i></a>
                                        </td>                                                                         
                                    </tr>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group bmd-form-group is-filled">
                                                                    ...
                                                                    <img class="img-fluid img-thumbnail" src="<?php echo URL::asset('public/upload/service/'.$s->image.'') ?>" style="height:30px;width:40px;">
                                                                    @if ($errors->has('image'))
                                                                    <strong class="text-danger">{{ $errors->first('image') }}</strong>                                  
                                                                    @endif
                                                                </div>
