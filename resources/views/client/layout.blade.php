        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="{{ route('kycForm') }}"
                    class="nav-link {{ request()->routeIs('kycForm') ? 'active' : '' }}">
                    <i class="material-icons">assignment_ind</i> KYC Details
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ url('client/bank-details') }}"
                    class="nav-link {{ request()->routeIs('bankForm') ? 'active' : '' }}">
