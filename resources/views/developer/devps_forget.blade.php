...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Forget Password Reset - Mellow Elements</title>
                        ...
                        <div class="auth-form">
                            <div class="row">
                                <div class="col">
                                   ...
                                   <form method="post" action="{{route('senddevps_forget')}}">
                                        @csrf
                                        <div class="form-group">
                                        <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Registered Email Address">
                                            @if ($errors->has('email'))
                                        ...
                                        <!--</div>-->
                                        <a href="{{ route('developer_registration') }}"><span>Don't Have An Account?</span></a><br>
                                        <!--<a href="{{ route('devps_forget') }}"><span>Forget Password</span></a>-->
