    ...
    <center>
        <div class="row">  
            ...
            <div class="col-8 col-lg-8 col-sm-8 col-md-8" style=" background-color: #d9d0d02e;border-radius: 20px;padding: 20px 20px 20px 20px;left: 20%;">
                ...
                <h1 class="">YOUR PREMIUM PLAN IS COMPLETED!</h1>
                ...
                <hr style="width:97%">
                <a class="btn  btn-primary btn-lg" href="{{route('developer_profile')}}" role="button">Go to Profile <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
