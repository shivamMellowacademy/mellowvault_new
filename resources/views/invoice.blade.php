        ...
        <table style="border:1px solid #ccc;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    foreach($show as $d) {
                    $price = $d->hostingprice; ?>
                     
                    <tr>
                        <td style="border:1px solid #ccc; padding:0px 10px 10px 60px;"> {{$i}}</td>
                        <td style="border:1px solid #ccc; padding:0px 10px 10px 60px;">{{$d->hostingname}}</td>
                        <td style="border:1px solid #ccc; padding:0px 10px 10px 60px;">INR {{$d->hostingprice}}</td>
                    </tr>    
