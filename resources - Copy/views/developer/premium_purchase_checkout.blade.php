...
@section('content')
<div id="paymentLoader" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); z-index: 9999; justify-content: center; align-items: center;">
...
document.getElementById('paymentButton').addEventListener('click', function(e) {
    ...
    // Manual validation
    let isValid = true;
    const requiredFields = ['fname', 'lname', 'email', 'phone', 'country', 'state', 'address_one', 'city', 'code'];
    ...
    const totalPrice = <?php echo $total_price * 100; ?>;
