                            ...
                            <div class="modal-content border-0 shadow-lg">
                                ...
                                <form method="POST" action="{{ route('schedule_interview_resource') }}">
                                    ...
                                    <div class="modal-footer border-0">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="confirmInterviewBtn">
...
$('form').on('submit', function(e) {
    e.preventDefault();
    const form = $(this);
    const submitBtn = form.find('#confirmInterviewBtn');
    const loader = form.find('.loader-container');
    ...
    $.ajax({
        ...
        complete: function() {
            // Always re-enable button when complete
            submitBtn.show();
            loader.hide();
        }
    });
